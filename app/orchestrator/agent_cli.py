...
def cmd_catalog(_args: argparse.Namespace) -> int:
    from shared.ai.agent import build_agent_catalog
...
def cmd_compile(args: argparse.Namespace) -> int:
    from shared.ai.agent import compile_natural_language
    from shared.ai.agent.schemas import StandardVideoJobRequest
...
def cmd_validate(args: argparse.Namespace) -> int:
    from shared.ai.agent import validate_standard_request
    from shared.ai.agent.schemas import StandardVideoJobRequest
