"""Content planner adapter for panel_tutor."""
...
def build_panel_tutor_content_plan(request, summary: dict | None = None) -> ContentPlan:
    del summary
    brief = ContentBrief(
        topic="创作控制台用户指南",
        ...
        tags=["panel_tutor", request.platform.value, request.style.value],
    )
