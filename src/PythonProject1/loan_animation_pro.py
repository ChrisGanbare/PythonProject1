...
# 贷款参数
# ============================================================
LOAN_AMOUNT   = 1_000_000   # 100万元
ANNUAL_RATE   = 0.045        # 年利率4.5%
...
# 视频规格（竖屏 9:16）
# ============================================================
FIG_W        = 1080 / 100   # 10.8 inch
FIG_H        = 1920 / 100   # 19.2 inch
DPI          = 100
FPS          = 30
TOTAL_SECS   = 30
...
def generate_loan_animation():
    ...
    OUTPUT = r'D:\PythonProject1\loan_comparison_flourish.mp4'
    print(f'  输出: {OUTPUT}')
