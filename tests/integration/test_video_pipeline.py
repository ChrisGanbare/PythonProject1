...
pytestmark = pytest.mark.skipif(
    not _CV2_AVAILABLE,
    reason="opencv-python 未安装，跳过帧级视频管道测试（pip install opencv-python 后可运行）",
)
...
from shared.render.core.task_manager import TaskManager, TaskStatus
from shared.render.media.video_editor import VideoEditor
from shared.output.platform.presets import get_platform_preset
from shared.output.platform.video_request import PlatformName, PlatformRenderRequest, RenderQuality
