...
from shared.render.visualization.backends.manim_backend import (
    QUALITY_FLAGS,
    QUALITY_FOLDERS,
    ManimVizBackend,
)
from shared.render.visualization.protocol import VizRenderBackend
from shared.render.visualization.types import VideoFormatSpec
...
class TestManimRegistration:
    ...
    def test_get_backend_manim(self):
        from shared.render.visualization.registry import get_backend
