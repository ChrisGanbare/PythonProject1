...
from shared.render.visualization.render_cache import render_cache_dir, sanitize_cache_segment
...
def test_render_cache_dir(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("shared.render.visualization.render_cache.settings", _S())
